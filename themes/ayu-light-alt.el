;;; themes/ayu-light-alt.el -*- lexical-binding: t; -*-
...
(def-doom-theme doom-ayu-light
  ...
  (
   ...
   (common-bg       '("#EDEDED" "black"   "black"  ))
   (common-fg       '("#7C8893" "grey"    "grey"   ))
   (common-ui       '("#ba9199" "grey"    "grey"   ))
   (test            '("#2ea8e6" "grey"    "grey"   ))
   ;; syntax
   (syntax-tag      '("#55b4d4" "cyan"    "blue"   ))
   (syntax-func     '("#F28F73" "yellow"  "yellow" ))
   ...
   (syntax-keyword  '("#6BB9E0" "orange"  "orange" ))
   ...
   (modeline-bg
    (if -modeline-bright
      ...
      `(,(doom-lighten (car bg) 0.55) ,@(cdr base0))))
   (modeline-bg-l
    (if -modeline-bright
